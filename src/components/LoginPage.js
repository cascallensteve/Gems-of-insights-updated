      ...
      <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
        <div className="relative w-full max-w-4xl bg-white rounded-xl shadow-xl overflow-hidden grid md:grid-cols-2 max-h-[85vh] md:max-h-[90vh] overflow-y-auto">
          ...
          <div className="relative p-4 md:p-8">
            <button className="absolute left-4 top-4 text-sm text-gray-600 hover:text-emerald-700" onClick={onClose}>← Back</button>
            <button className="absolute right-4 top-4 text-2xl leading-none text-gray-600 hover:text-emerald-700" onClick={onClose}>×</button>
